    ...
    attributes:(NSDictionary *)attributeDict
{
    ...
    if ([elementName isEqualToString:@"status"] || [elementName isEqualToString:@"retweeted_status"]) {
  ...
  namespaceURI:(NSString *)namespaceURI qualifiedName:(NSString *)qName
{
    ...
    } else if ([elementName isEqualToString:@"status"] || [elementName isEqualToString:@"retweeted_status"]) {
        [self addSource];
        currentNode = nil;
    }
}
